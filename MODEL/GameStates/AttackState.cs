...
{
    /// <summary>
    /// Combat state activated when standing on a field containing an enemy.
    /// Allows selecting and executing visitor attack strategies.
    ...
    public class AttackState : IGameState
    {
        ...
        public AttackState()
        {
            ...
            actions.Add(GameCommands.Up, ("Select Previous", c => Actions.SelectAttack(c, -1)));
            actions.Add(GameCommands.Down, ("Select Next", c => Actions.SelectAttack(c, 1)));

            actions.Add(GameCommands.Attack, ("Attack", c => Actions.FightTurn(c)));
